...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'QiuZiwen', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '持续专注 ｜ 开放心态 ｜ 共创共享', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'qiuziwen.youjoying.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '数据, 算法, AI, Blog, 博客', // 网站关键词 英文逗号隔开
